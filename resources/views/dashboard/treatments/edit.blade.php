                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" value="{{ $treatment->name }}" placeholder="Enter name">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div>
                                            <div class="mb-4 d-flex justify-content-center">
                                                <img src="{{ asset('storage/' . $treatment->image) }}" alt="current image" style="width: 300px;" />
                                            </div>
