    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('assets') }}/images/t1.png" alt="">
            </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('assets') }}/images/t2.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Eye Care
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('assets') }}/images/t3.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Pediatrician Clinic
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('assets') }}/images/t4.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Parental Care
